...
function showLatestPost(){
    ...
    .then(data => {
        ...
        naslov.innerText = data[1].title.rendered; 
        text.innerText = data[1].excerpt.rendered.substring(data[1].excerpt.rendered.indexOf(">") + 1, data[1].excerpt.rendered.indexOf("&"));
        link = data[1].link;
