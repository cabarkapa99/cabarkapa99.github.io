...
function showData(data){
    ...
    if(popust.postoji){
        ...
        document.querySelector('.popust-image-wrapper .popust').innerText = popust.procenat + "%";
    ...
    if(popust.postoji){
        document.querySelector('.popust-image-wrapper .nova-cena').innerText = "Nova cena: " + (entries[2][1] - (entries[2][1] * popust.procenat / 100)) + " rsd"; 
    }
}
...
const applyStyles = function(){
    ...
    for(const input of inputs){
        input.addEventListener('change', ()=>{
            let polje;
            if(popust.postoji){
                polje = document.querySelector('.popust-image-wrapper .content-wrapper .selected p');
            }else{
                polje = document.querySelector('.content-wrapper .selected p');
            }
...
const showPreview = function(){
    ...
    for(const data of Data){
        ...
        contentWrapper.querySelector('.cena p').innerText = entries[2][0] + ": " + entries[2][1] + " rsd";
        if(popust.postoji){
            slicica.querySelector('.nova-cena').innerText = "Nova cena: " + (entries[2][1] - (entries[2][1] * popust.procenat / 100)) + " rsd"; 
            slicica.querySelector('.popust').innerText = popust.procenat + "%";
        }
